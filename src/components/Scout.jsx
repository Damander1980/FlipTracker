...
import QuickScan from "./scout/QuickScan";
...
export default function Scout({ settings, onAddItem, passes = [], onPassLogged, todaysPurchases = [] }) {
  ...
  const handlePurchased = (data) => {
    onAddItem({
      ...
      status: "Unlisted",
      notes: data.identified?.redFlags ? `${data.identified.redFlags}` : "",
  ...
  // QUICK SCAN MODE - full screen overlay
  ...
  return (
    <div className="page scout-home">
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
        ...
        <button
          onClick={() => setView(SCOUT_VIEWS.QUICK_SCAN)}
          style={{
            display: "flex",
            alignItems: "center",
            gap: 6,
